...
namespace BCEdit180.Core.Editor.Classes.Annotations {
    public class AnnotationViewModel : BaseViewModel {
        ...
        public string PreviewTypeName { // should not be edited by users; only used as a preview
            ...
            set => this.RaisePropertyChanged(ref this.previewTypeName, value);
        }
        ...
        public string FullTypeName {
            ...
            set {
                this.RaisePropertyChanged(ref this.fullTypeName, value);
        ...
        public int ArrayDepth { // read only
            get => this.arrayDepth;
            set => this.RaisePropertyChanged(ref this.arrayDepth, value);
        }

        private int sizeOnStack;
        public int SizeOnStack { // read only
            get => this.sizeOnStack;
            set => this.RaisePropertyChanged(ref this.sizeOnStack, value);
        }
