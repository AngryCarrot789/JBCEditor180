...
namespace BCEdit180.Core.Editor.Classes.ExceptionTable {
    public class TryCatchBlockViewModel : BaseViewModel {
        ...
        public long StartIndex {
            get => this.startIndex;
            set => this.RaisePropertyChanged(ref this.startIndex, value);
        }

        public long EndIndex {
            get => this.endIndex;
            set => this.RaisePropertyChanged(ref this.endIndex, value);
        }

        public long HandlerIndex {
            get => this.handlerIndex;
            set => this.RaisePropertyChanged(ref this.handlerIndex, value);
        }

        public string HandlerType {
            get => this.handlerType;
            set => this.RaisePropertyChanged(ref this.handlerType, value);
        }
        ...
        public bool IsFinallyBlock {
            ...
            set => this.RaisePropertyChanged(ref this.isFinallyBlock, value);
        }
