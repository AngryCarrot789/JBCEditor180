...
namespace BCEdit180.Core.Editor.Classes.Bytecode.Instructions {
    public class TableSwitchInstructionViewModel : BaseSwitchInstructionViewModel {
        ...
        public int LowValue {
            get => this.lowValue;
            set => this.RaisePropertyChanged(ref this.lowValue, value);
        }

        private int highValue;
        public int HighValue {
            get => this.highValue;
            set => this.RaisePropertyChanged(ref this.highValue, value);
        }
        ...
        public override void Load(Instruction instruction) {
            ...
            this.SetCallbacks(this.DefaultLabel);
