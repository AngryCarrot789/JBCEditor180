...
namespace BCEdit180.Core.Editor.Classes.Editors {
    public class MethodAccessEditorViewModel : BaseConfirmableDialogViewModel {
        ...
        public bool FlagSyncrionized {
            ...
            set => this.RaisePropertyChanged(ref this.flagSyncrionized, value);
        }
        ...
        public bool FlagNative {
            get => this.flagNative;
            set => this.RaisePropertyChanged(ref this.flagNative, value);
        }
        ...
        public bool FlagBridge {
            get => this.flagBridge;
            set => this.RaisePropertyChanged(ref this.flagBridge, value);
        }
        ...
        public bool FlagVarargs {
            ...
            set => this.RaisePropertyChanged(ref this.flagVarargs, value);
        }
        ...
        public MethodAccessEditorViewModel(IDialog dialog) : base(dialog) {
        }
    }
}