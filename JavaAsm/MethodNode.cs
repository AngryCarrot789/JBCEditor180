...
namespace JavaAsm {
    ...
    public class MethodNode {
        ...
        internal void Parse(ClassReaderState reader) {
            ...
            {
                AttributeNode attribute = this.GetAttribute(PredefinedAttributeNames.Code);
            ...
            {
                AttributeNode attribute = this.GetAttribute(PredefinedAttributeNames.Exceptions);
                if (attribute != null)
                    this.Throws = (attribute.ParsedAttribute as ExceptionsAttribute)?.ExceptionTable;
            }
            this.AnnotationDefaultValue = (this.GetAttribute(PredefinedAttributeNames.AnnotationDefault)?.ParsedAttribute as AnnotationDefaultAttribute)?.Value;
